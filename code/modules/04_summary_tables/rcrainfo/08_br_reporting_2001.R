# =============================================================================
# FILE:     08_br_reporting_2001.R
# PURPOSE:  Build the Biennial Report 2001 cycle summary workbook from the raw
#           BR_REPORTING_2001 table, using the shared engine.
# INPUTS:   data/rcrainfo/br/BR_REPORTING_2001.csv,
#           data/rcrainfo/hd/HD_LU_NAICS.csv; sources 00_function.R
# OUTPUTS:  output/summary_tables/Biennial Report 2001 Summary Tables.xlsx
# AUTHOR:   Jason Ye
# CREATED:  2026-07-07
# UPDATED:  2026-07-07
# =============================================================================

# "Biennial Report 2001 Summary Tables.xlsx" from the raw BR_REPORTING_2001
...
#
# Reads data/rcrainfo/br/BR_REPORTING_2001.csv (+ BR lookup tables and
# data/rcrainfo/hd/HD_LU_NAICS.csv for labels); writes
# output/summary_tables/Biennial Report 2001 Summary Tables.xlsx.
...
year     <- 2001L
out_file <- "output/summary_tables/Biennial Report 2001 Summary Tables.xlsx"
...
build_module_summary(
  ...
  module_desc = "Biennial Report 2001 - the hazardous-waste report that LQGs and TSDFs file every two years.",
  missing_notes = list(
    categorical = c(
