...
# PURPOSE:  Build the Financial Assurance module summary workbook from the raw
#           FA_COST_ESTIMATE table and its companion FA tables, via the engine.
# INPUTS:   data/rcrainfo/fa/FA_COST_ESTIMATE.csv and other data/rcrainfo/fa/*.csv;
...
# per handler x FA-type x coverage), via the shared engine (00_function.R), so
