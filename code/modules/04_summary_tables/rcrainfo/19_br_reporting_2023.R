# =============================================================================
# FILE:     19_br_reporting_2023.R
# PURPOSE:  Build the Biennial Report 2023 cycle summary workbook from the raw
#           BR_REPORTING_2023 table, using the shared engine.
# INPUTS:   data/rcrainfo/br/BR_REPORTING_2023.csv,
#           data/rcrainfo/hd/HD_LU_NAICS.csv; sources 00_function.R
# OUTPUTS:  output/summary_tables/Biennial Report 2023 Summary Tables.xlsx
# AUTHOR:   Jason Ye
# CREATED:  2026-07-07
# UPDATED:  2026-07-07
# =============================================================================

# "Biennial Report 2023 Summary Tables.xlsx" from the raw BR_REPORTING_2023
...
# request) with the same spec; the per-cycle glossary notes differ. 2023 adds
# COUNTRY_CODE and MIXED_WASTE columns, which fall into "Variables Not
# Summarized" automatically.
#
# Reads data/rcrainfo/br/BR_REPORTING_2023.csv (+ BR lookup tables and
# data/rcrainfo/hd/HD_LU_NAICS.csv for labels); writes
# output/summary_tables/Biennial Report 2023 Summary Tables.xlsx.
...
year     <- 2023L
out_file <- "output/summary_tables/Biennial Report 2023 Summary Tables.xlsx"
...
lab_brform <- c(GM = "Generation And Management", WR = "Waste Received", XX = "Site Identification Form Only")
...
build_module_summary(
  ...
  module_desc = "Biennial Report 2023 - the hazardous-waste report that LQGs and TSDFs file every two years.",
  missing_notes = list(
    categorical = c(
