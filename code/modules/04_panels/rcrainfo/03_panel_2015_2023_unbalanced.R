# =============================================================================
# 03_panel_2015_2023_unbalanced.R
#
...
# counterpart (01_panel_2015_2023_balanced.R) keeps only handlers recognized in all five
# cycles; this panel is a strict superset of it, built by the same rules.
#
# Columns
...
out_file <- "output/panels/BR_PANEL_2015_2023_UNBALANCED.csv"
...
# Unbalanced: every handler qualifying in >= 1 cycle stays, one row per cycle
# in which it qualifies (the balanced panel instead requires all five cycles).
