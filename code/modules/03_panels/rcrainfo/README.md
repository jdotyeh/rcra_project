...
month-level aggregation rules are the substance of each script; the shared
helpers handle the FRS link and the writing.
...
and [state authorization](../../../../docs/institutional/04_state_authorization.md)
